...
const UserDashboard = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-200px)] pb-24">
        ...
        {cards.map((card, index) => {
          ...
          return (
            ...
            >
              ...
              <p className={`text-[8px] sm:text-[9px] md:text-[12px] font-bold mb-auto leading-tight transition-colors duration-300 ${
                darkMode ? 'text-gray-200' : 'text-black'
              }`}>{card.title}</p>
              <p className={`text-[10px] sm:text-xs md:text-sm font-semibold mt-auto transition-colors duration-300 ${
      ...
      <div className={`rounded-lg sm:rounded-xl md:rounded-2xl px-3 py-3 sm:px-4 sm:py-4 md:px-6 md:py-5 flex gap-3 sm:gap-4 md:gap-6 shadow-sm hover:shadow-md transition-all duration-200 mr-4 my-4 ${
        darkMode ? 'bg-gray-800' : 'bg-white'
      }`}>
      ...
      <div className="fixed bottom-4 z-50 lg:left-[225px] lg:right-0 left-0 right-0 px-2 sm:px-4">
        <div className="max-w-4xl mx-auto">
          <div className={`w-full rounded-4xl px-4 py-3 flex items-center gap-3 shadow-lg transition-all duration-300 ${
            darkMode 
